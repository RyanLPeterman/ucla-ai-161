...
(cond ((dfid '((A (B)) C (D)) 3) '(C A C D A B C D) (print "Test 3 Success"))
      (t                                            (print "Test 3 Failure")))
(cond ((dfid '((A (B)) C (D)) 2) '(C A C D)         (print "Test 4 Success"))
      (t                                            (print "Test 4 Failure")))
(cond ((dfid '((A (B)) C (D)) 1) '(C)               (print "Test 5 Success"))
      (t                                            (print "Test 5 Failure")))
(cond ((dfid '((A (B)) C (D)) 0) NIL                (print "Test 6 Success"))
      (t                                            (print "Test 6 Failure")))
(cond ((dfid '(A (B C) (D) (E (F G))) 1) '(A)       (print "Test 7 Success"))
      (t                                            (print "Test 7 Failure")))
(cond ((dfid '(A (B C) (D) (E (F G))) 2) '(A A B C D E)
                                                    (print "Test 8 Success"))
      (t                                            (print "Test 8 Failure")))
(cond ((dfid '(A (B C) (D) (E (F G))) 3) '(A A B C D E A B C D E F G)     
